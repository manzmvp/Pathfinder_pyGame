...
class MainMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text("Start Game", 15, self.startx, self.starty-44)
            self.game.draw_text("Options", 15, self.optionsx, self.optionsy-20)
    ...
    def move_cursor(self):
        if self.game.DOWN_KEY:
            if self.state == 'Start':
                ...
                self.cursor_rect.midtop = (self.startx + self.offset, self.starty-44)
                self.state = 'Start'
...
class CreditsMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text('Made by Manoj', 11, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 + 10)
            self.blit_screen()
